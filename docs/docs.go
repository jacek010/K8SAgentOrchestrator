...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_rest.CreateAgentRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/agents/{name}/cache/{field}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Value and optional TTL",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_rest.CacheSetRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/agents/{name}/env": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "New env list",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_rest.EnvSetRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_rest.EnvMergeRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/agents/{name}/logs": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Only lines newer than N seconds",
                        "name": "sinceSeconds",
                        "in": "query"
                    },
                    {
                    ...
                    },
                    {
                        "type": "boolean",
                        "default": false,
                        "description": "Stream logs (chunked transfer)",
                        "name": "follow",
                        "in": "query"
                    }
                ],
        ...
        "/readyz": {
            "get": {
                ...
                "responses": {
                    ...
                    "503": {
                        "description": "k8s api not reachable",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
    ...
    "definitions": {
        ...
        "internal_rest.CreateAgentRequest": {
            "type": "object",
            "required": [
                "image",
                "name"
            ...
            "properties": {
                ...
                "servicePort": {
                    "description": "ServicePort, if non-zero, causes the controller to create a ClusterIP Service on that port.",
                    "type": "integer"
                },
                "serviceProtocol": {
                    "description": "ServiceProtocol is the protocol of the service port (TCP/UDP/SCTP). Default: TCP.",
                    "type": "string"
                }
            }
        },
        "internal_rest.EnvMergeRequest": {
            "type": "object",
            "required": [
                "env"
            ],
    ...
    "tags": [
        ...
        {
            "description": "Agent (Pod) CRUD operations",
            "name": "agents"
        },
        {
            "description": "Start / stop / restart agents",
            "name": "lifecycle"
        },
        {
        ...
        {
            "description": "Pod log retrieval and streaming",
            "name": "logs"
        },
        {
            "description": "Per-agent in-memory key-value cache",
            "name": "cache"
        }
    ]
}`
